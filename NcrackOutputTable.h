 ...
 *                                                                         *
 ***********************IMPORTANT Ncrack LICENSE TERMS************************
 *                                                                         *
 * The Ncrack Security Scanner is (C) 1996-2009 Insecure.Com LLC. Ncrack is    *
 * also a registered trademark of Insecure.Com LLC.  This program is free  *
 * software; you may redistribute and/or modify it under the terms of the  *
 * GNU General Public License as published by the Free Software            *
 * Foundation; Version 2 with the clarifications and exceptions described  *
 * below.  This guarantees your right to use, modify, and redistribute     *
 * this software under certain conditions.  If you wish to embed Ncrack      *
 * technology into proprietary software, we sell alternative licenses      *
 * (contact sales@insecure.com).  Dozens of software vendors already       *
 * license Ncrack technology such as host discovery, port scanning, OS       *
 ...
 * following:                                                              *
 * o Integrates source code from Ncrack                                      *
 * o Reads or includes Ncrack copyrighted data files, such as                *
 *   Ncrack-os-db or Ncrack-service-probes.                                    *
 * o Executes Ncrack and parses the results (as opposed to typical shell or  *
 *   execution-menu apps, which simply display raw Ncrack output and so are  *
 *   not derivative works.)                                                * 
 * o Integrates/includes/aggregates Ncrack into a proprietary executable     *
 *   installer, such as those produced by InstallShield.                   *
 * o Links to a library or executes a program that does any of the above   *
 *                                                                         *
 * The term "Ncrack" should be taken to also include any portions or derived *
 * works of Ncrack.  This list is not exclusive, but is meant to clarify our *
 * interpretation of derived works with some common examples.  Our         *
 * interpretation applies only to Ncrack--we don't speak for other people's  *
 * GPL works.                                                              *
 *                                                                         *
 * If you have any questions about the GPL licensing restrictions on using *
 * Ncrack in non-GPL works, we would be happy to help.  As mentioned above,  *
 * we also offer alternative license to integrate Ncrack into proprietary    *
 * applications and appliances.  These contracts have been sold to dozens  *
 * of software vendors, and generally include a perpetual license as well  *
 * as providing for priority support and updates as well as helping to     *
 * fund the continued development of Ncrack technology.  Please email        *
 ...
 *                                                                         *
 * Source code also allows you to port Ncrack to new platforms, fix bugs,    *
 * and add new features.  You are highly encouraged to send your changes   *
 * to Ncrack-dev@insecure.org for possible incorporation into the main       *
 * distribution.  By sending these changes to Fyodor or one of the         *
 * Insecure.Org development mailing lists, it is assumed that you are      *
 * offering the Ncrack Project (Insecure.Com LLC) the unlimited,             *
 * non-exclusive right to reuse, modify, and relicense the code.  Ncrack     *
