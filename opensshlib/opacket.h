...
/* Map old to new API */
void     ssh_packet_start(ncrack_ssh_state *, u_char);
void     ssh_packet_put_char(ncrack_ssh_state *, int ch);
void     ssh_packet_put_int(ncrack_ssh_state *, u_int value);
void     ssh_packet_put_int64(ncrack_ssh_state *, u_int64_t value);
void     ssh_packet_put_bignum(ncrack_ssh_state *, BIGNUM * value);
void     ssh_packet_put_bignum2(ncrack_ssh_state *, BIGNUM * value);
void     ssh_packet_put_ecpoint(ncrack_ssh_state *, const EC_GROUP *, const EC_POINT *);
void     ssh_packet_put_string(ncrack_ssh_state *, const void *buf, u_int len);
void     ssh_packet_put_cstring(ncrack_ssh_state *, const char *str);
void     ssh_packet_put_raw(ncrack_ssh_state *, const void *buf, u_int len);
void     ssh_packet_send(ncrack_ssh_state *);

u_int	 ssh_packet_get_char(ncrack_ssh_state *);
u_int	 ssh_packet_get_int(ncrack_ssh_state *);
u_int64_t ssh_packet_get_int64(ncrack_ssh_state *);
void     ssh_packet_get_bignum(ncrack_ssh_state *, BIGNUM * value);
void     ssh_packet_get_bignum2(ncrack_ssh_state *, BIGNUM * value);
void	 ssh_packet_get_ecpoint(ncrack_ssh_state *, const EC_GROUP *, EC_POINT *);
void	*ssh_packet_get_string(ncrack_ssh_state *, u_int *length_ptr);
char	*ssh_packet_get_cstring(ncrack_ssh_state *, u_int *length_ptr);
